...
public class CardAleatorioCursorAdapter extends CursorAdapter {

    private LayoutInflater cursorInflater;
    Context contexts;
    AlertDialog.Builder builder;
    private AlertDialog excluirCard;
    String idCard;


    public CardAleatorioCursorAdapter(final Context context, Cursor c) {
        super(context, c, 0);
        contexts = context;
        ...
        builder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                ...
                final Cursor cursorNovo = listaCard.listarInicial(context, Contract.Tabelas.TABLE_NAME3);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        return LayoutInflater.from(context).inflate(R.layout.item_cards_aleatorios, parent, false);
    }
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        TextView tvTexto = (TextView) view.findViewById(R.id.texto_card);
        ...
        ImageView imFoto = (ImageView) view.findViewById(R.id.imagem);
