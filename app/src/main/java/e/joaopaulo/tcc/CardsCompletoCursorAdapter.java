...
public class CardsCompletoCursorAdapter extends CursorAdapter {
    ...
    public CardsCompletoCursorAdapter(final Context context, Cursor c) {
        super(context, c, 0);
        contexts = context;
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        return LayoutInflater.from(context).inflate(R.layout.item_card_completo, parent, false);
    }
